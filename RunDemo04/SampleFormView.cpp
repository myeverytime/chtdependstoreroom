...
void CSampleFormView::SetInfo(int m_List,int iItem,CString strSubA,CString strSubB,CString strSubC) 
{
	...
	if (m_List == 2)
	{
		m_List2.SetItem(iItem+1, 0, LVIF_TEXT, strSubA, 0, NULL, NULL, NULL);
		m_List2.SetItem(iItem+1, 1, LVIF_TEXT, strSubB, 0, NULL, NULL, NULL);
		m_List2.SetItem(iItem+1, 2, LVIF_TEXT, strSubC, 0, NULL, NULL, NULL);
	}
	if (m_List == 3)
	{
		m_List3.SetItem(iItem+2, 0, LVIF_TEXT, strSubA, 0, NULL, NULL, NULL);
		m_List3.SetItem(iItem+2, 1, LVIF_TEXT, strSubB, 0, NULL, NULL, NULL);
		m_List3.SetItem(iItem+2, 2, LVIF_TEXT, strSubC, 0, NULL, NULL, NULL);
	}
