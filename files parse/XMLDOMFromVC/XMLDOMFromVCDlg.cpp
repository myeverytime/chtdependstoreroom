// XMLDOMFromVCDlg.cpp : implementation file
//

#include "stdafx.h"
#include "XMLDOMFromVC.h"
#include "XMLDOMFromVCDlg.h"
...
CXMLDOMFromVCDlg::CXMLDOMFromVCDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CXMLDOMFromVCDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CXMLDOMFromVCDlg)
...
void CXMLDOMFromVCDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CXMLDOMFromVCDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CXMLDOMFromVCDlg, CDialog)
	//{{AFX_MSG_MAP(CXMLDOMFromVCDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CXMLDOMFromVCDlg message handlers

BOOL CXMLDOMFromVCDlg::OnInitDialog()
{
...
void CXMLDOMFromVCDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CXMLDOMFromVCDlg::OnQueryDragIcon()
{
